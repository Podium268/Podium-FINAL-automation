...
module.exports = async function runRateAndMessageMultipleLadies(page, tierConfigs) {
  ...
  const m1 = 'Left some twinkle twinkle stars for you! ( • ᴗ - ) ✧';
  const m2 = 'you look so pretty! visited with love <3'; //already won
  const m3 = 'you look so pretty! visited with love <3'; //168
