...
'Cayle','Feme Star','M A R I','Elizabeth','jas','WaFaa','Veronica Park','smyle','Dee Dee Kelley','Indila','Zelda Hyrule','Her Majesty','Felis Felicitas','Wild Rose','Agent X','Giggles','Pania','Everest','RAMBØ XT','Katniss Everdeen','Queen Taylen','.Auksė',
  ...
  const m1 = 'You’re sweeter than the bottom of a Cornetto cone.🍦';
  const m2 = 'You’re sweeter than the bottom of a Cornetto cone.🍦'; //already won
  const m3 = 'You’re sweeter than the bottom of a Cornetto cone.🍦'; //168
