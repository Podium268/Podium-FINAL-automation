...
module.exports = async function runRateAndMessageMultipleLadies(page, tierConfigs) {
  ...
  const m1 = 'If it doesnt challenge you it wont change you, Have a great day!(heart)';
  const m2 = 'If it doesnt challenge you it wont change you, Have a great day!(heart)'; //already won
  const m3 = 'If it doesnt challenge you it wont change you, Have a great day!(heart)'; //168
