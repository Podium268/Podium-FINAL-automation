...
'Cayle','M A R I','Elizabeth','jas','WaFaa','Veronica Park','smyle','Dee Dee Kelley','Indila','Zelda Hyrule','Her Majesty','Felis Felicitas','Wild Rose','Agent X','Giggles','Pania','Everest','RAMBØ XT','Katniss Everdeen','Queen Taylen','.Auksė',
  ...
  const m1 = 'Even the sunflowers would turn to look at you.🌻';
  const m2 = 'Even the sunflowers would turn to look at you.🌻'; //already won
  const m3 = 'Even the sunflowers would turn to look at you.🌻'; //168
