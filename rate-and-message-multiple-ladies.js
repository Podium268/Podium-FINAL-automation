...
module.exports = async function runRateAndMessageMultipleLadies(page, tierConfigs) {
  ...
  const m1 = 'You’re looking supercalifragilisticexpialidocious today!(heart)';
  const m2 = 'You’re looking supercalifragilisticexpialidocious today!(heart)'; //already won
  const m3 = 'You’re looking supercalifragilisticexpialidocious today!(heart)'; //168
