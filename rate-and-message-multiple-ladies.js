...
module.exports = async function runRateAndMessageMultipleLadies(page, tierConfigs) {
  ...
  const m1 = 'Skipping compliments today, just showering you with love and kisses.';
  const m2 = 'Skipping compliments today, just showering you with love and kisses.'; //already won
  const m3 = 'Skipping compliments today, just showering you with love and kisses.'; //168
